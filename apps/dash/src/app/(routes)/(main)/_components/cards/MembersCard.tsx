     ...
     return (
          <>
               <div className="flex items-center space-x-2">
                    ...
                    <span className="inline-flex h-6 w-6 items-center justify-center rounded-tremor-full bg-primary/5 text-tremor-label font-medium text-tremor-content-strong dark:bg-dark-tremor-background-subtle dark:text-dark-tremor-content-strong">
                         {data.length}
                    </span>
               </div>
               ...
               <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {data.map((member) => (
                         <Card key={member.name} className="group p-4 bg-primary/[3%] ring-0">

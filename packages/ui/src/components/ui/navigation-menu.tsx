...
const navigationMenuTriggerStyle = cva(
     "group inline-flex h-10 w-max items-center justify-center text-[15px] font-normal transition-colors hover:text-slate-800 focus:outline-none disabled:pointer-events-none disabled:opacity-50"
)
